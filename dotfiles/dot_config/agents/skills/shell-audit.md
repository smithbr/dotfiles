...
Audit and refactor shell scripts in the current location for consistency, safety, and modern best practices.
...
- Ensure `shellcheck` is available (install via package manager if missing).
